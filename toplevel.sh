...
nextpnr-ecp5 --json toplevel.json --textcfg toplevel_out.config --um5g-85k --package CABGA381 --lpf toplevel.lpf --freq 3 && # XXX: freq = 3 just to make router pass wo/ error!
